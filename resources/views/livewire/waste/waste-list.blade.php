    ...
    <x-slot name="thead">
        <tr role="row">
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 22%;"
                aria-sort="ascending" aria-label="Agent: activate to sort column descending">Waste Scrap Percentage <i
                    class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" wire:click="sortBy('waste_scrap_percentage')"></i>
            </th>
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 23%;"
                aria-label="Company Email: activate to sort column ascending">Waste Scrap Actual <i
                    class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" wire:click="sortBy('waste_scrap_actual')"></i></th>
        ...
        <tr class="filter">
            <th>
                <x-admin.input type="search" wire:model.defer="searchPercentage" placeholder="" autocomplete="off"
    ...
    <x-slot name="tbody">
        @forelse($datas as $data)
            <tr role="row" class="odd">   
                <td>{{ $data->waste_scrap_percentage }}</td>
                <td>{{ $data->waste_scrap_actual }}</td>
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('waste-scrap.edit', ['waste_scrap' => $data->id]) }}"><i
