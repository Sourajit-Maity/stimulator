<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form">
                    <x-admin.form-group>
                        <x-admin.lable value="Product Name" />
                            <x-admin.dropdown  wire:model.defer="overall_sale_id" placeHolderText="Please select one" disabled autocomplete="off" class="{{ $errors->has('overall_sale_id') ? 'is-invalid' :'' }} " readonly>
