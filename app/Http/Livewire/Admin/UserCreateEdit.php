...
class UserCreateEdit extends Component
{
    use WithFileUploads;
    use AlertMessage;
    public $first_name,$industry,$activity,$details, $last_name, $email, $password, $phone, $active, $password_confirmation, $user, $model_id;
    public $address;
    public $isEdit = false;
    public $statusList = [];
    public $industryList = [];
    ...
    public function mount($user = null)
    {
        ...
        $this->industryList = [
            ...
            ['value' => 1, 'text' => "Engineering"],
            ['value' => 2, 'text' => "Inactive"]
        ];
        $this->activityList = [
            ['value' => 0, 'text' => "Choose User"],
            ['value' => 1, 'text' => "Manufacture"],
            ['value' => 2, 'text' => "Trading"]
        ];
